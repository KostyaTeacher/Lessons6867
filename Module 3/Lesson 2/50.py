...
right_button2 = Button(root, text="Я Права кнопка", bg="purple", fg="white", font=("Arial", 12), padx=20, pady=10)
right_button2.pack(side="right", fill="y", expand=True, padx=10, pady=10)
